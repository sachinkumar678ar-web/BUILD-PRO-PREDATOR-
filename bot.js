...
// ==========================================
// ⚙️ CONFIGURATION (आपकी नई डिटेल्स)
// ==========================================
...
function generatePrediction(nextId) {
    ...
    // 💣 SINGLE COLOR SAFE NUMBER LOGIC
    let finalNumArray = [];
